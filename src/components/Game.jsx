...
const Game = ({ games, list }) => {
    ...
    return <div className="game" style={{
        ...
        <img src={games.img} alt="game-pic" className='game-pic' style={{
            marginLeft: (list) ? '20px' : '0px'
        }} />

        <div className="container-game-infos" style={{
            alignItems: (list) ? 'start' : 'center',
            marginLeft: (list) ? '20px' : '0px'
        }} >
            ...
            <p className="description-game" style={{
            ...
            <div className="buttons-game">
                ...
                <input type="button" value="Detalhes" onClick={() => setLgShow(true)} style={{
